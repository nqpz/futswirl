...
-- the size of your GPU memory and on Futhark's general memory usage.  Even if
-- you *can* set this to a high value, memory-wise, you will likely get a more
-- fluid experience with a lower number.  The default of 512 MiB seems to work
-- well enough across different systems.
